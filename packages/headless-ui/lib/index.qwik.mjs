import { componentQrl, inlinedQrl, useId, useStylesScopedQrl, useSignal, useStore, _jsxC, useLexicalScope, Slot, _IMMUTABLE, _fnSignal, _jsxBranch, useStylesQrl, useVisibleTaskQrl, useOnDocument, _jsxS, _wrapSignal } from "@builder.io/qwik";
...
`, "Collapse_component_useStylesScoped_n6oJGUNCH40"));
  ...
  return /* @__PURE__ */ _jsxC(Lt, {
    get tag() {
      return props.rootProps?.tag || "details";
    },
    ...props.rootProps,
    children: /* @__PURE__ */ _jsxC(Lt, {
...
`, "Dialog_component_useStyles_fwdn9cAxUmY"));
  ...
  return /* @__PURE__ */ _jsxC(Lt, {
    ...
    children: /* @__PURE__ */ _jsxC(Lt, {
      ...props.wrappers?.rootChildren,
      children: [
        props.triggerButton && /* @__PURE__ */ _jsxC(Lt, {
          get tag() {
            ...
            children: [
              /* @__PURE__ */ _jsxC(Lt, {
                ...
                children: [
                  ...
                  props?.closeButton && /* @__PURE__ */ _jsxC(Lt, {
                    get tag() {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxC(Lt, {
          ...
          children: [
            ...
            props.items?.map((item, i) => /* @__PURE__ */ _jsxC(Lt, {
